...
public class KotlinWhenExpressionTest extends ValidationTestBase {
	...
	public void whenSealed() {
		...
		assertLine("whenSealed.case2", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenSealed.return", ICounter.FULLY_COVERED, 0, 0);
	}
	...
	public void whenSealedRedundantElse() {
		assertLine("whenSealedRedundantElse.when", ICounter.FULLY_COVERED, 0, 0);
		...
		assertLine("whenSealedRedundantElse.else", ICounter.NOT_COVERED, 0, 0);
		assertLine("whenSealedRedundantElse.return", ICounter.FULLY_COVERED, 0, 0);
	}
	...
	public void whenEnum() {
		...
		assertLine("whenEnum.case1", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenEnum.case2", ICounter.PARTLY_COVERED, 0, 0);
		assertLine("whenEnum.return", ICounter.FULLY_COVERED, 0, 0);
	}
	...
	public void whenEnumRedundantElse() {
		...
		assertLine("whenEnumRedundantElse.case1", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenEnumRedundantElse.case2", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenEnumRedundantElse.else", ICounter.NOT_COVERED, 0, 0);
		assertLine("whenEnumRedundantElse.return", ICounter.FULLY_COVERED, 0, 0);
	}
	...
	public void whenString() {
		...
		assertLine("whenString.case1", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenString.case2", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenString.case2", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenString.else", ICounter.FULLY_COVERED, 0, 0);
		assertLine("whenString.return", ICounter.FULLY_COVERED, 0, 0);
	}
